...
fun OnBoardingScreen(){
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Row (
            ...
            PagerIndicator(modifier = Modifier.width(Dimens.pageIndicatorWidth), pagesSize = pages.size, selectedPage = pagerState.currentPage)
